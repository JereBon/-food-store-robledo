...
| **us-004-productos** | EPIC 05 & 06 (Sprint 3) | [cite_start]CRUD de productos, stock, asociación de categorías y gestión del perfil de cliente. [cite: 2077, 2078, 2079] | 📝 Pendiente |
| **us-005-carrito** | EPIC 08 (Sprint 4) | [cite_start]Carrito persistente client-side con Zustand y personalización de ingredientes. [cite: 2080, 2081] | 📝 Pendiente |
| **us-006-pedidos** | EPIC 09 & 10 (Sprint 5) | [cite_start]Validación de disponibilidad y creación atómica de pedidos con Snapshots (UoW). [cite: 2082, 2083] | 📝 Pendiente |
...
| **us-009-direcciones**| EPIC 07 (Sprint 4) | [cite_start]CRUD de direcciones de entrega y selección de dirección predeterminada. [cite: 2080, 2081] | 📝 Pendiente |