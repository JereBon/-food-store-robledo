...
| **us-001-auth** | EPIC 01 & 02 (Sprint 1) | [cite_start]Autenticación JWT, RBAC (4 roles), rotación de refresh tokens y navegación protegida. [cite: 2073, 2074] | ⏳ En proceso |
| **us-002-categorias**| EPIC 03 & 04 (Sprint 2) | [cite_start]Gestión jerárquica de categorías (CTE) e ingredientes con alérgenos. [cite: 2075, 2076] | 📝 Pendiente |
